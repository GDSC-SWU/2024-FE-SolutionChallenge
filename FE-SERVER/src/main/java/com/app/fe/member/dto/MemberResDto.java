...
import com.app.fe.nation.dto.NationResDto;
...
public class MemberResDto {
    ...
    public static class Detail {
        ...
        private NationResDto.Detail tblNation;
        ...
        public static Detail of(Member tblMember) {
            return Detail.builder()
                    ...
                    .tblNation(Objects.nonNull(tblMember.getTblNation()) ? NationResDto.Detail.of(tblMember.getTblNation()) : null)
                    .build();
        }
    }
}
